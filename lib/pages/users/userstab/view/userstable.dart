        ...
        return ref.watch(itemsUserModelFilteredProvider).length > 0
            ? DataTable2(
                ...
                rows: List<DataRow>.generate(
                  ref.watch(valueSearchProviderInUser).length > 0
                      ? ref
                              .watch(itemsUserModelFilteredProvider.notifier)
                              .getSearchUsers(ref.watch(valueSearchProviderInUser))
                              .length ??
                          0
    ...
    return DataRow2.byIndex(
      ...
      onSelectChanged: (value) {
        if (userModel.selected != value) {
          ...
          ref.read(itemsUserModelFilteredProvider.notifier).updateUser(userModel);
          //单选  多选注释
