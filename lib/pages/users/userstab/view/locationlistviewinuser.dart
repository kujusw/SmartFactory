                  ...
                  return Column(
                    children: [
                      GestureDetector(
                        onTap: () {
                          //多选
                          if (ref.watch(locationSelectInUserStateProvider).contains(locationModels[index])) {
                            ref.read(locationSelectInUserStateProvider.notifier).removeLocation(locationModels[index]);
                          } else {
                            ref.read(locationSelectInUserStateProvider.notifier).addLocation(locationModels[index]);
                          }
                        },
                        child: Container(
                          height: 48.h,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Visibility(
                                visible: ref.watch(locationSelectInUserStateProvider).contains(locationModels[index]),
                                child: Icon(
                                  Icons.done,
                                  size: 30.h,
