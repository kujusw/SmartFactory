                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (value) {
                            ref.read(valueSearchInUserProvider.notifier).setValue(value);
                          },
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: GestureDetector(
                              onTap: () {
                                if (ref.read(valueSearchInUserProvider).toString().length > 0) {
                                  ref.read(valueSearchInUserProvider.notifier).setValue("");
                                  searchController.clear();
                                }
                              },
                              child: ref.watch(valueSearchInUserProvider).toString().length > 0
                                  ? Icon(
                                      Icons.close,
                                      color: ref.watch(colorProvider)['text'],
                                      size: 20.h,
