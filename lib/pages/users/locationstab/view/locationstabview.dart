                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (value) {
                            ref.read(valueSearchProviderInLocation.notifier).state = value;
                          },
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: GestureDetector(
                              onTap: () {
                                if (ref.read(valueSearchProviderInLocation).toString().length > 0) {
                                  ref.read(valueSearchProviderInLocation.notifier).state = "";
                                  searchController.clear();
                                }
                              },
                              child: ref.watch(valueSearchProviderInLocation).toString().length > 0
                                  ? Icon(
                                      Icons.close,
                                      color: ref.watch(colorProvider)['text'],
                                      size: 20.sp,
