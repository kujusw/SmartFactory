...
import 'rolestable.dart';

class RolesTableWidget extends ConsumerWidget {
  RolesTableWidget({Key? key}) : super(key: key);
                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (value) {
                            ref.read(valueSearchInRoleProvider.notifier).setValue(value);
                          },
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: GestureDetector(
                              onTap: () {
                                if (ref.read(valueSearchInRoleProvider).toString().length > 0) {
                                  ref.read(valueSearchInRoleProvider.notifier).setValue("");
                                  searchController.clear();
                                }
                              },
                              child: ref.watch(valueSearchInRoleProvider).toString().length > 0
                                  ? Icon(
                                      Icons.close,
                                      color: ref.watch(colorProvider)['text'],
                                      size: 20.sp,
                      ...
                      // SizedBox(
                      //   width: ref
                      //               .watch(itemsRoleModelFilteredProvider)
                      //               .firstWhere((element) => element.selected == true,
                      //                   orElse: () => RoleModel(selected: false))
                      //               .selected ??
                      //           false
                      //       ? 10.w
                      //       : 0,
                      ...
                      Visibility(
                        child: Container(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () async {
                              bool result = await ref.read(deleteRoleProvider.notifier).deleteRole(
                                  ref
                                          .watch(roleUIManagerProvider)
                                          .firstWhere((element) => element.selected == true)
                                          .id ??
                                      0,
                              ...
                              if (result) {
                                ...
                                unawaited(SmartDialog.showToast("Failed to delete role"));
                              }
                            },
                          ),
                        ),
