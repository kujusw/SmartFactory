                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                          ...
                          onChanged: (value) {
                            ref.read(valueSearchProviderInRole.notifier).state = value;
                          },
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: GestureDetector(
                              onTap: () {
                                if (ref.read(valueSearchProviderInRole).toString().length > 0) {
                                  ref.read(valueSearchProviderInRole.notifier).state = "";
                                  searchController.clear();
                                }
                              },
                              child: ref.watch(valueSearchProviderInRole).toString().length > 0
                                  ? Icon(
                                      Icons.close,
                                      color: ref.watch(colorProvider)['text'],
                                      size: 20.sp,
