...
import '../../notifier/permissionselectuimanager.dart';
        ...
        return data.length > 0
            ? DataTable2(
                ...
                rows: List<DataRow>.generate(
                  ref.watch(permissionSelectUIManagerProvider).length,
                  (index) => rolesDataRow(ref.watch(permissionSelectUIManagerProvider)[index], index, ref),
                ),
              )
            : Container();
      },
      ...
      child: Checkbox(
        ...
        onChanged: (bool? value) {
          if (type == "read") {
            ...
            ref.read(permissionSelectUIManagerProvider.notifier).updatePermissionSelect(permissionSelect);
          } else {
            if (value ?? false) {
