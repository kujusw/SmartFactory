...
class _IOSSettingsTileState extends State<IOSSettingsTile> {
  ...
  Widget buildDescription({
    ...
    final scaleFactor = textScaleFactor.scale(10) / 10;
    return Container(
      ...
      decoration: BoxDecoration(
        color: theme.themeData.globalBackground,
      ),
      ...
      children: [
        ...
        if (widget.tileType == SettingsTileType.switchTile)
          CupertinoSwitch(
            ...
            activeTrackColor: widget.enabled ? widget.activeSwitchColor : theme.themeData.inactiveTitleColor,
          ),
  ...
  Widget buildTileContent(
    ...
    return GestureDetector(
      ...
      child: Container(
        color: isPressed ? theme.themeData.tileHighlightColor : theme.themeData.whiteDarkGray,
