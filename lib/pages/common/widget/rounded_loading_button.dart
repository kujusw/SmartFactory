...
class RoundedLoadingButtonState extends State<RoundedLoadingButton> with TickerProviderStateMixin {
    ...
    final btn = ButtonTheme(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          ...
          disabledForegroundColor: widget.disabledColor?.withValues(alpha: 0.38),
          disabledBackgroundColor: widget.disabledColor?.withValues(alpha: 0.12),
  ...
  void _start() {
    ...
    if (widget.resetAfterDuration) unawaited(_reset());
  }
