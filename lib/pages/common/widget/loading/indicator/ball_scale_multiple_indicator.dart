...
class BallScaleMultipleIndicator extends Indicator {
  ...
  paint(Canvas canvas, Paint paint, Size size) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      canvas.drawCircle(Offset(width / 2, height / 2), (width / 2 - circleSpacing) * scaleDoubles[i], paint);
    }
  }
  ...
  List<AnimationController> animation() {
    ...
    for (int i = 0; i < 3; i++) {
      var sizeController = new AnimationController(duration: const Duration(milliseconds: 1000), vsync: context);
