...
class PacmanIndicator extends Indicator {
  ...
  paint(Canvas canvas, Paint paint, Size size) {
    ...
    canvas.drawCircle(Offset((1 - translateX) * size.width, size.height / 2), radius, paint);
  }

  @override
  List<AnimationController> animation() {
    var controllers = <AnimationController>[];
    var controller = new AnimationController(duration: Duration(milliseconds: 325), vsync: context);
