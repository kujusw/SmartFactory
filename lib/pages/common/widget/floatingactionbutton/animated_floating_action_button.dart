...
class AnimatedFloatingActionButton extends ConsumerStatefulWidget {
  ...
  final Function(bool) onFabToggle;
  ...
  AnimatedFloatingActionButton(
      ...
      r})
      : assert(
          durationAnimation >= 100 && durationAnimation <= 1000,
...
class AnimatedFloatingActionButtonState extends ConsumerState<AnimatedFloatingActionButton>
  ...
  Widget build(BuildContext context) {
    if (ref.watch(floatButtonRestoreProvider)) {
  ...
  Widget _buildMainFAB() {
    return FloatingActionButton(
      ...
      child: AnimatedIcon(
        ...
        color: _isOpened ? widget.colorEnd : widget.colorStart,
