  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FloatingActionButton(
        ...
        onPressed: () {
          ref.read(floatButtonProvider.notifier).changeFloatButton("BoardsViewAdd");
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FloatingActionButton(
        backgroundColor: ref.watch(colorProvider)['backgroundColorWidget'],
        onPressed: () {
          ref.read(floatButtonProvider.notifier).changeFloatButton("BoardsViewEdit");
        },
        heroTag: "Edit",
        tooltip: 'Edit',
        child: Icon(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FloatingActionButton(
        backgroundColor: ref.watch(colorProvider)['backgroundColorWidget'],
        onPressed: () {
          ref.read(floatButtonProvider.notifier).changeFloatButton("BoardsViewDelete");
        },
        heroTag: "Delete",
        tooltip: 'Delete',
        child: Icon(
