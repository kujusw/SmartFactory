...
import '../draggable/card_draggable.dart';
import '../draggable/draggable_state.dart';
import '../draggable/list_draggable.dart';
...
class DraggableProviderState {
  ...
  DraggableProviderState({this.cardDraggable, this.draggableType = DraggableType.none, this.listDraggable});
