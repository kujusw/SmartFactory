...
class KJScreenUtil {
  ...
  static final KJScreenUtil _singleton = KJScreenUtil();

  static KJScreenUtil get(BuildContext context) {
    _singleton._init(context);
    return _singleton;
  }
  ...
  static final Set<PointerDeviceKind> kTouchLikeDeviceTypes = <PointerDeviceKind>{
